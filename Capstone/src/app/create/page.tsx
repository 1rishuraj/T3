...
import { createCampaign, usePulseRaiseProgram } from '@/services/blockchain'
...
export default function Page() {
  ...
  const [form, setForm] = useState({
   ...
   const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault() //e.preventDefault() stops the form's default page reload on submit, letting below async code run smoothly instead.
