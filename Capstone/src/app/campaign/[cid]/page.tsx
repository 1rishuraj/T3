...
import { fetchAllDonations, fetchAllWithdrawals, fetchCampaignDetails, usePulseRaiseProgram } from '@/services/blockchain'
  ...
  useEffect(() => {
    if (cid) {
      const fetchDetails = async () => {
        await fetchCampaignDetails(program!, cid as string, dispatch)
        await fetchAllDonations(program!, cid as string, dispatch)
        await fetchAllWithdrawals(program!, cid as string, dispatch)
      }
